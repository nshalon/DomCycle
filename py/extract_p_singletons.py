...
with open(args.ifn_cycle_sum) as sum:
    ...
    for line in sum:
        ...
        total_non_support = avg_singleton + avg_paired_weird
        ...
        if total_non_support == 0 and bottleneck == 0:
            score = 0
        elif total_non_support == 0:
            score = "inf"
        else:
            score = round(bottleneck_reads / total_non_support, 3)
